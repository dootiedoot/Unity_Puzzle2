...
namespace PicaVoxel
{
    ...
    public class Exploder : MonoBehaviour
    {
        ...
        public void Explode(Vector3 additionalVelocity)
        {
            ...
            {
                if (ExplodeTarget == ExplodeTargets.AllButSelf && o.transform.root == transform.root) continue;
                if (ExplodeTarget == ExplodeTargets.SelfOnly && o.transform.root != transform.root) continue;
